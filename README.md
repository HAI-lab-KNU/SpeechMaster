...
- **sdk/** — Google Actions SDK bilan ishlash uchun asosiy papka  
- **manifest.yaml** — loyiha haqida umumiy metadata  
- **actions/** — foydalanuvchi chaqiradigan actionlar  
- **custom/** — intentlar va dialog logikasi  
- **settings/** — loyiha konfiguratsiyasi  
- **webhooks/** — backend bilan bog‘lovchi handlerlar  
